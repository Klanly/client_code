...
namespace MuGame
{
    public class OpenDoor111 : MonoBehaviour
    {
        public int triggerTimes = 1;
        int km_count;
        int mid;
        public int doorkill;
        Dictionary<int, int> allkill = new Dictionary<int, int>();//当前击杀相应的mid的怪物的数量
        ...
        void Start()
        {
            ...
            data = SvrLevelConfig.instacne.get_level_data(111);
