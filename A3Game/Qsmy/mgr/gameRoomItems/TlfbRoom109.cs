...
namespace MuGame
{
    class TlfbRoom109: BaseRoomItem
    {
        ...
        public override void onStart(Variant svr)
        {
            ...
            isOpen = true;
            data = MapModel.getInstance().getMapDta(109);
            if (data == null)
            {
                data = new MapData();
            }
            MapModel.getInstance().AddMapDta(109, data);
            ...
            a3_insideui_fb.ShowInUI(a3_insideui_fb.e_room.TLFB109);
