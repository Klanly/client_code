...
namespace MuGame
{
    class TlfbRoom110: BaseRoomItem
    {
        ...
        public override void onStart(Variant svr)
        {
            ...
            isOpen = true;
            data = MapModel.getInstance().getMapDta(110);
            if (data == null)
            {
                data = new MapData();
            }
            MapModel.getInstance().AddMapDta(110, data);
            ...
            a3_insideui_fb.ShowInUI(a3_insideui_fb.e_room.TLFB110);
