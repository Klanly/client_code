...
namespace MuGame
{
	class ExpRoom : BaseRoomItem
	{
		...
		public override void onStart(Variant svr) {
			...
			isOpen = true;
			data = MapModel.getInstance().getMapDta(101);
			if (data == null) {
				data = new MapData();
			}
			MapModel.getInstance().AddMapDta(101, data);
			data.OnKillNumChange = (int i) => {
				if (a3_insideui_fb.instance != null) {
					a3_insideui_fb.instance.SetKillNum(i,-1,101);
				}
			}; 
            ...
            a3_insideui_fb.ShowInUI(a3_insideui_fb.e_room.Exp);
        ...
        //    return true;
        //}
        public override bool onLevel_Status_Changes(Variant msgData)
        {
            if (msgData.ContainsKey ("bo")) {
                int e = msgData["bo"];
                if (a3_insideui_fb.instance != null)
                {
                    a3_insideui_fb.instance.SetInfBo(e);
                }
            }         
            return true;
        }
...
(Action<object>)((object o) => {
    ...
    a3_insideui_fb.instance.setAct();
            ...
            //a3_insideui_fb.instance.exp_tra.gameObject.SetActive(false);
            //a3_insideui_fb.instance.money_tra.gameObject.SetActive(false);
            //a3_insideui_fb.instance.cailiao_tra.gameObject.SetActive(false);
            //a3_insideui_fb.instance.mlzd_tra.gameObject.SetActive(false);
            //a3_insideui_fb.instance.zhsly_tra.gameObject.SetActive(false);
            //a3_insideui_fb.instance.normal.gameObject.SetActive(false);
            //a3_insideui_fb.instance.btn_quit.gameObject.SetActive(true);
