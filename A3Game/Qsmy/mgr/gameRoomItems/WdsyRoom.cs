...
namespace MuGame
{
    class WdsyRoom : BaseRoomItem
    {
        ...
        public override void onStart(Variant svr)
        {
            ...
            isOpen = true;
            data = MapModel.getInstance().getMapDta(108);
            if (data == null)
            {
                data = new MapData();
            }
            MapModel.getInstance().AddMapDta(108, data);
            ...
            a3_insideui_fb.ShowInUI(a3_insideui_fb.e_room.WDSY);
