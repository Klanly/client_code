...
public class LScrollPage : MonoBehaviour, IBeginDragHandler, IEndDragHandler
{
    ScrollRect rect;
    //页面：0，1，2，3  索引从0开始
    ...
    public void OnHardDrag(bool isLeftOrRight)
    {
        ...
        //MuGame.a3_chatroom._instance.textItemCurrentPage.text =
        //    string.Format("{0}/{1}", currentPageIndex + 1, pages.Count);
    }
    void UpdatePages()
    {
        // 获取子对象的数量
