...
//        public uint clanTaskItemId;
//        private Image imgProcess;
//        private long timeWaitTerminal;
//        private long timeKillTerminal;
//        private GameObject winKillMon;
//        public static A3_ClanTaskOpt Instance;
//        public bool IsOnClanTaskWait { get; set; }
//        public bool isWaiting;
//        public bool isOnKillMon { get; set; }
//        public bool IsOnClanTaskGet { get; set; }
//        public Vector3 waitPosition;
//        public Vector3 killPosition;
//        public BaseButton BtnWait;
//        public bool isClanTaskMonsterAlive;
//        public bool isKeepingKillMon;
//        private Text liteMinimapClanTaskTip;
//        public Text LiteMinimapClanTaskTip
//        {
//            get
//            {
//                if (liteMinimapClanTaskTip == null)
//                    liteMinimapClanTaskTip = a3_liteMinimap.instance.GetClanTaskPage()?.FindChild("name").GetComponent<Text>();
//                return liteMinimapClanTaskTip;
//            }
//            set
//            {
//                liteMinimapClanTaskTip = value;
//            }
//        }
...
//            {
//                if (submitItemIId != 0)
//                    A3_TaskProxy.getInstance().SendSubmit(A3_TaskModel.getInstance().GetClanTask()?.taskId ?? 0, submitItemIId);
//                tfSubmitItem.gameObject.SetActive(false);
//            };
//            transform.SetParent(skillbar.instance.transform);
//            LiteMinimapClanTaskTip = a3_liteMinimap.instance.GetClanTaskPage()?.GetComponent<Text>();
//            A3_TaskProxy.getInstance().addEventListener(A3_TaskProxy.ON_TASK_REFRESH, OnCheck);            
//            if (A3_TaskModel.getInstance().GetClanTask()?.lose_tm > muNetCleint.instance.CurServerTimeStamp)
//            {
//                isKeepingKillMon =
//                isClanTaskMonsterAlive = true;
//                timeKillTerminal = A3_TaskModel.getInstance().GetClanTask().lose_tm;
//            }
//            name = "A3_ClanTaskOpt";
...
//            {
//                Variant task = e.data["change_task"];
//                if (task.ContainsKey("id") && A3_TaskModel.getInstance().GetTaskDataById(task["id"]).taskT == TaskType.CLAN)
//                {
//                    if (task.ContainsKey("cnt") && task["cnt"] > 0)
//                    {
//                        isKeepingKillMon = false;
//                        isClanTaskMonsterAlive = false;
//                        LiteMinimapClanTaskTip.text = A3_TaskModel.getInstance().GetClanTask().taskName;
//                        return;
//                    }
//                    if (task.Count > 0 && A3_TaskModel.getInstance().GetTaskDataById(task["id"]).targetType == TaskTargetType.KILL_MONSTER_GIVEN)
//                    {
//                        isKeepingKillMon = true;
//                        isClanTaskMonsterAlive = true;
//                        timeKillTerminal = task["lose_tm"];
//                    }
//                }
//            }
//            else if (e.data.ContainsKey("cmis"))
//            {
//                int taskId = e.data["cmis"]["id"];
//                if (A3_TaskModel.getInstance().GetTaskDataById(taskId).targetType == TaskTargetType.KILL_MONSTER_GIVEN)
//                {
//                    isKeepingKillMon = true;
//                    isClanTaskMonsterAlive = true;
//                    timeKillTerminal = e.data["cmis"]["lose_tm"];
//                }
//                else
//                    if (A3_TaskModel.getInstance().GetTaskDataById(taskId).targetType == TaskTargetType.GET_ITEM_GIVEN)
//                    clanTaskItemId = A3_TaskModel.getInstance().GetTaskXML().GetNode("task", "id==" + taskId).getUint("target_param2");
//            }
//        }
//        void Update()
//        {
//            if (a1_gamejoy.inst_joystick.moveing)
//            {
//                if (isWaiting)
//                    StopCD();
...
//            if (isKeepingKillMon)
//            {
//                if (A3_TaskModel.getInstance().GetClanTask() != null)
//                    if (timeKillTerminal < muNetCleint.instance.CurServerTimeStamp)
//                        isClanTaskMonsterAlive = false;
//                    else if (LiteMinimapClanTaskTip != null)
//                        LiteMinimapClanTaskTip.text = A3_TaskModel.getInstance().GetClanTask().taskName + GetSecByTime(timeKillTerminal);
//            }
...
//            A3_TaskProxy.getInstance().SendWaitStart(A3_TaskModel.getInstance().GetClanTask().taskId);
//            if (timeCD > 0)
...
//            if (isClanTaskMonsterAlive)
//                return;
//            A3_TaskProxy.getInstance().SendCallMonster((uint)A3_TaskModel.getInstance().GetClanTask().taskId);            
//            winKillMon.SetActive(false);
//        }
...
//                if (items[idx[i]].tpid == clanTaskItemId)
//                {
//                    Transform tfIcon;
...
//            IsOnClanTaskWait = haveEnteredWaitPosition = false;
...
//            StopCoroutine(RunCD());
//            if (isFinish)
//                A3_TaskProxy.getInstance().SendWaitEnd(A3_TaskModel.getInstance().GetClanTask().taskId);
//        }
